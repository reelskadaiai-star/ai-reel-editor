...
import type { Job, ContentType, TransitionStyle } from "@/lib/types";
...
function EditorInner() {
  ...
  // ── Content type ──────────────────────────────────────────────────────
  async function handleContentTypeChange(ct: ContentType) {
    await updateJob(jobId, { contentType: ct, contentTypeConfirmed: true });
    mutate();
                ...
                {activeTab === "captions" && (
                  <motion.div key="captions" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    <div className="card space-y-3">
                      <h3 className="font-semibold text-sm text-white/70">Caption Style</h3>
                      ...
                      <div className="pt-1 border-t border-white/5">
                        <h3 className="font-semibold text-sm text-white/70 mb-3">Detected Speech</h3>
