...
CAPTION_POOLS: dict[str, list[str]] = {
    ...
    "education": [
        ...
        "Write this down 📝",
        "Save this for later 🔖",
        "This knowledge is worth millions",
        "Step by step 👆",
    ...
    "lifestyle": [
        ...
        "The glow-up is real ✨",
        "This routine changed everything 🌟",
        "Morning ritual ☀️",
